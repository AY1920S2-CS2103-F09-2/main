...
|`* * *` |student with good work-life balance |view tasks with different labels (e.g. health, work) under different tabs |
...
|`* * *` |student who has a flexible schedule |reorder my tasks easily |
